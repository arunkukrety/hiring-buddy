"""LLM-based Resume Parser for any resume format."""
...
class LLMResumeParser:
    """LLM-based resume parser that can handle any resume format."""
    
    def __init__(self, llm_model: str = "gpt-4o"):
        self.llm_model = llm_model
    
    def parse_resume(self, resume_path: str, llm) -> ResumeData:
        """Parse any resume format using LLM."""
    ...
    def _extract_text_alternative_pdf(self, pdf_path: str) -> str:
